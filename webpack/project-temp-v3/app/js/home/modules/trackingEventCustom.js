...
module.exports = (function(){
  ( function( $, window, document, undefined ) {
    ...
    ***/
    ...
    $('.m-home-usp__show-my-points').on('click', function(e) {
