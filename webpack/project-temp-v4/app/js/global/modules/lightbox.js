...
const LightBox = (() => {
  ...
  var lightBox = ( elem, options ) => { 
    ...
    var 
      ...
      isTouch = Utility.isTouch(),
      isPluginOpen = false,
      currentItemSrc = null,
      currentItemIndex = null,
      currentX = 0,
      html = /*jshint multistr: true */'<div class="m-lightbox">\
                ...
                <i class="m-lightbox__ui-close"><i class="icon icon-x"></i></div>\
              </div>';
    ...
    ui = {
      ...
      bindEvents : function ( ){
        ...
        $( '.m-lightbox .ui-carousel-arrow-left' ).on( userAction, function( event ) {
          event.preventDefault();
          // event.stopPropagation();   // Removing this for tracking purposes
          $this.actions.goPrev();
        } );
      ...
      actions : {
        ...
        goNext: function ( ) { 
          ...
          if ( index + 1 < elements.length ) {
            ...
            // if ( $( '.m-lightbox__slide-item.current .m-lightbox__media-video-iframe').length && !Utility.isMobile() ){
      ...
      _components: {
        ...
        media:  { 
          ...
          calculateMedia: function(){ 
            ...
            wWidth = Utility.winWidth();
            wHeight = Utility.winHeight();
            ...
            function onWindowResize() {
              ...
              sliderCss = '.m-lightbox__media { width:' + newImgWidth + 'px; height:' + newImgHeight + 'px;} .m-lightbox__ui-bottom-place-holder { height:' + uiHeight + 'px; }';
          ...
          getVideo : function( url, autoplay ) {
            ...
            var iframe = '',
              ...
              autoPlaySetting = autoPlaySetting = autoplay ? 1 : 0; /*jshint multistr: true */
            
            if ( youtubeUrl || youtubeShortUrl) {
              if ( youtubeShortUrl ) {
                youtubeUrl = youtubeShortUrl;
              }
              iframe = '<iframe class="m-lightbox__media-video-iframe" width="560" height="315" src="//www.youtube.com/embed/' + youtubeUrl[1] + '?autoplay='+ autoPlaySetting + '&rel=0&enablejsapi=1&version=3&playerapiid=ytplayer&wmode=opaque" frameborder="0" allowscriptaccess="always" allowfullscreen="true"></iframe>';
  ...
  nexonWebApp.lightBox = lightBox;
  // nexonWebApp.lightBox = lightBox.close;



  $.fn.appLightBox = function( options ) {
     
    nexonWebApp.lightBox( this, options );
