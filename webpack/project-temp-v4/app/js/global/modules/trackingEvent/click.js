...
module.exports = (() => {
  ( function( $, window, document, undefined ) {
    ...
    trackingEventClick(); // For Global Tracking Event w/ [Source or no Source]

    window.nexonWebApp.trackingEventClick = trackingEventClick; // For Tracking Event with custom event handler
