...
window.app.projectName = {

  main: 'Project Name',
  trackingEvent: 'V update'

};

window.app.config = {
  cdn: '/',
  redirectCookie: window.app.projectName.main,
  shadowCookie: `${window.app.projectName.main}_SC`,
  twitterPage: window.app.projectName.main.toLowerCase(),  
  points: {
    'enabled': false,
    'facebook': 100,
    'twitter': 100,
  ...
  banners: {
    ...
    champion: {
      link: '/micro-site/v-update/17915',
      show: true,
    }
  }
}; 