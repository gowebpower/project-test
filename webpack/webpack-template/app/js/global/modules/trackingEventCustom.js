...
module.exports = (function(){
  ( function( $, window, document, undefined ) {
    ...
    ***/
    ...
    //   app.trackingEventClick( this, [ 'V Update', 'FB Share > ' + app.trackingInfo.source + ' > ' + app.trackingInfo.shortTitle ] );

    // });

    // $('body').on('click', '.shareButtonsBox .share-twitter', function() {

    //   app.trackingEventClick( this, [ 'V Update', 'TW Share > ' + app.trackingInfo.source + ' > ' + app.trackingInfo.shortTitle ] );
    ...
    //   // app.trackingEventClick( this, [ 'V Update', 'Share for Points > ' + app.trackingInfo.source + ' > ' + app.trackingInfo.isLoggedIn() + ' > ' + app.trackingInfo.shortTitle  + ' > Close Window' ] );
    //   app.trackingEventClick( this, [ 'V Update', 'Share for Points > ' + app.trackingInfo.source  + ' > Close Window' ] );
