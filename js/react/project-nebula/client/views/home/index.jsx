                ...
                <Row className="l-row-container">
                  <Column small={12} className="">
                    ...
                    <div className="m-home-hero__mouse-icon sr-top">
                      <img src={ window.appNebula.config.assetsURL + "images/home/mouse-icon.png"} alt=""/>
                    ...
                    {/*  <div className="m-home-links__top left">
                      ...
                      */}
                      ...
                      <div className="m-home-links__bottom sr-top">

                        <div className="m-home-links__logo icon-logo"></div>
                        <Link to="/join" activeClassName="active" className="m-home-links__title">JOIN US</Link>
